...
SECRET_KEY = os.environ.get("SECRET_KEY", "django-insecure-x&eu8)b5@b^gan*-dqtn9xgrq^=^iupx9oo8b9i)phgdr8@gpd")
...
#     "config.storage_backends.MediaStorage"  # the media storage configurations
# )
